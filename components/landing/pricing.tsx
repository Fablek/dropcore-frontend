    ...
    <section className="py-16 px-4 max-w-6xl mx-auto text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="border rounded-2xl p-6 shadow-sm">
          ...
          <ul className="text-left space-y-2 mb-6 text-sm">
            <li className="flex items-center gap-2">
              <FaCheck /> 5 GB storage
            </li>
            <li className="flex items-center gap-2">
              <FaCheck /> File upload & preview
            </li>
            <li className="flex items-center gap-2">
        ...
        <div className="border-2 border-violet-500 rounded-2xl p-6 shadow-md">
          ...
          <ul className="text-left space-y-2 mb-6 text-sm">
            <li className="flex items-center gap-2">
              <FaCheck /> 100 GB storage
            </li>
            <li className="flex items-center gap-2">
              <FaCheck /> Priority support
            </li>
            <li className="flex items-center gap-2">
              <FaCheck /> Advanced file search
            </li>
          </ul>
          <Link
            href="/signup"
        ...
        <div className="border rounded-2xl p-6 shadow-sm">
          ...
          <ul className="text-left space-y-2 mb-6 text-sm">
            <li className="flex items-center gap-2">
              <FaCheck /> Unlimited storage (your hardware)
            </li>
            <li className="flex items-center gap-2">
              <FaCheck /> Full control
            </li>
            <li className="flex items-center gap-2">
              <FaCheck /> Open-source
            </li>
